...
import EcomProductDetailScreen from '../../screens/E-commerce/ProductDetail';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator
        ...
        {/* EcomProductDetailScreen */}

        <Stack.Screen
          name={'EcomProductDetailScreen'}
          component={EcomProductDetailScreen}
          options={{
            animation: 'slide_from_bottom',
          }}
        />
